...
# Modify this to point to your venus installation dir,
# relative to planet dir above.
VENUS_INSTALL = "venus"
...
print '<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Strict//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-strict.dtd">'  # nopep8
print '<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="sv"><head><meta http-equiv="Content-Type" content="text/html;charset=utf-8" /><title>Admin results</title></head><body>'  # nopep8
print '<div>'
...
print("<p><strong><a href='{url}'>Return</a>"
      " to admin interface</strong></p>".format(url=ADMIN_URL))
print("</body></html>")
