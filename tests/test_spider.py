...
class SpiderTest(unittest.TestCase):
    ...
    def test_filename(self):
        ...
        self.assertEqual(
            os.path.join(
                '.', 'planet.intertwingly.net,2006,testfeed1,1'), filename(
                '.', u'tag:planet.intertwingly.net,2006:testfeed1,1'))
        self.assertEqual(
            os.path.join(
                '.',
            ...
            filename(
                '.',
                u'urn:uuid:00000000-0000-0000-0000-000000000000'))
    ...
    def test_spiderThreads(self):
        ...
        status = sorted([int(rec[1])
                         for rec in log if str(rec[0]).startswith('GET ')])
